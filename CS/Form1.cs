...
namespace WindowsApplication1 {
    public partial class Form1 : Form {
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            pivotGridControl1.OptionsChartDataSource.ExportRowFieldValuesAsType = typeof(string);
            pivotGridControl1.OptionsChartDataSource.ExportColumnFieldValuesAsType = typeof(string);
            pivotGridControl1.OptionsChartDataSource.ExportCellValuesAsType = typeof(int);
            CreateEncodeTables();
