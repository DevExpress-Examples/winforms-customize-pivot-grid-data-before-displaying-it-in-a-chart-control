    ...
    Public Partial Class Form1
        ...
        Private Sub CreateEncodeTables()
            ...
            For Each value As Object In fieldProductName.GetUniqueValues()
                ProductEncodeTable.Add(value.ToString(), "Products: " & Math.Min(Threading.Interlocked.Increment(productCounter), productCounter - 1))
            Next

            Dim categoryCounter As Integer = 1
            For Each value As Object In fieldCategoryName.GetUniqueValues()
                CategoryEncodeTable.Add(value.ToString(), "Category: " & Math.Min(Threading.Interlocked.Increment(categoryCounter), categoryCounter - 1))
            Next
        End Sub
