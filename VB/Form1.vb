...
Namespace WindowsApplication1
	Partial Public Class Form1
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			pivotGridControl1.OptionsChartDataSource.ExportRowFieldValuesAsType = GetType(String)
			pivotGridControl1.OptionsChartDataSource.ExportColumnFieldValuesAsType = GetType(String)
			pivotGridControl1.OptionsChartDataSource.ExportCellValuesAsType = GetType(Integer)
			CreateEncodeTables()
		...
		Private Sub pivotGridControl1_CustomChartDataSourceData(ByVal sender As Object, ByVal e As PivotCustomChartDataSourceDataEventArgs) _
